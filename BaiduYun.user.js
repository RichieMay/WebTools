...
// @description       【百度网盘直链下载助手】是一款免客户端获取百度网盘文件真实下载地址的油猴插件，支持Windows，Mac，Linux，Android等多平台，可使用IDM，XDown等多线程加速工具加速下载，支持远程下载，4.0.0版本全新升级。
// @author            syhyz1990
// @license           AGPL
// @supportURL        https://github.com/syhyz1990/baiduyun
// @updateURL         https://github.com/RichieMay/WebTools/raw/master/BaiduYun.user.js
// @downloadURL       https://github.com/RichieMay/WebTools/raw/master/BaiduYun.user.js
...
!function () {
    ...
    function c() {
        ...
        function s() {
            ...
            }), D.click(T), I.click(A), V.click(p), E.click(u), O.click(S), R.click(P), i.append(G).append(d).append(m).append(R).append(O), e.append(t).append(i), e.hover(function () {
            ...
            $.ajax({
                url: "https://api.baiduyun.wiki/update?ver=" + h + "&s=web", method: "GET", success: function (e) {
                    if (GM_setValue("lastest_version", e.version), m = e.ua, 200 === e.code && e.version > h && Swal.fire({
                        title: '发现新版本 <span style="background: #da5961;vertical-align: top;display: inline-block;font-size: 14px;height: 18px;line-height: 18px;border-radius: 3px;padding: 0 6px;color: #fff;">' + e.version + "</span>",
                        icon: "success",
                        html: e.changelog,
                        ...
                        GM_setValue("scode", e.scode), GM_setValue("init", 1), history.go(0);
                    } else t();
                }
            });
        }
